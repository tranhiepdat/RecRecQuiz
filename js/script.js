...
async function preloadAllImages() {
    ...
    for (let i = 1; i <= 10; i++) {
        const questionImageUrl = `images/questions/${i}.webp`;
        questionImagePromises.push(preloadImage(questionImageUrl));
        
        const resultImageUrl = `images/results/${i - 1}.webp`; // Adjusting result image index
...
function takeScreenshot() {
    ...
    ctx.clearRect(
        screenshotButtonPos.x - 20, // Expand left
        screenshotButtonPos.y - 20, // Expand top
        screenshotButtonPos.width + 40, // Expand width to both left and right
