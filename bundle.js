...
function initialize() {
  ...
  preloadAllImages().then(function (images) {
...
function _preloadAllImages() {
  _preloadAllImages = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var questionImagePromises, resultImagePromises, i, questionImageUrl, resultImageUrl, _yield$Promise$all, _yield$Promise$all2, questionImages, resultImages;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 5;
          return Promise.all([Promise.all(questionImagePromises), Promise.all(resultImagePromises)]);
        case 5:
          _yield$Promise$all = _context.sent;
          _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 2);
          questionImages = _yield$Promise$all2[0];
          resultImages = _yield$Promise$all2[1];
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          imageAspectRatio = backgroundImage.width / backgroundImage.height; // Calculate new dimensions to fit the image inside the canvas
...
function showResult(personalityType) {
  ...
  var padding = canvas.height * 0.03; // Define top padding (3% of canvas height for smaller canvas)
  ...
  var textPadding = canvas.height * 0.01; // Padding between image and text (1.5% of canvas height)
  var textAreaWidth = canvas.width * 0.45; // Width of the text area for heading and explanation (45% of canvas width)
...
function takeScreenshot() {
  ...
  ctx.clearRect(screenshotButtonPos.x - 20,
  // Expand left
  screenshotButtonPos.y - 20,
  // Expand top
  screenshotButtonPos.width + 40,
  // Expand width to both left and right
  screenshotButtonPos.height + 40 // Expand height to both top and bottom
  );
